...
class dotpattern():
    def __init__(self):
        ...
        self.imagename='C:\\Program Files (x86)\\Jenkins\\jobs\\ColorCheck\\workspace\\images\\dotpattern.png'
        
    def run(self):    
        # params
        ini_filename = "dotpattern.ini"
		
        # write ini file
        SETTINGS_OBJ.root_directory = os.path.join(self.root,"lib")
        SETTINGS_OBJ.out_file_name=ini_filename
        SETTINGS_OBJ.default_file_name="default_dotpattern.ini"
        SETTINGS_OBJ.run();
         
        RUN_OBJ.image_name = self.imagename   
        RUN_OBJ.module_name = "dotpattern.exe"
