...
class sfr():
    def __init__(self):
        ...
        self.imagename='C:\\Program Files (x86)\\Jenkins\\jobs\\ColorCheck\\workspace\\images\\sfr.jpg'
        
    def run(self):    
        # params
        ini_filename = "sfr.ini"
		
        # write ini file
        SETTINGS_OBJ.root_directory = os.path.join(self.root,"lib")
        SETTINGS_OBJ.out_file_name=ini_filename
        SETTINGS_OBJ.default_file_name="default_sfr.ini"
        SETTINGS_OBJ.run();
         
        RUN_OBJ.image_name = self.imagename  
        RUN_OBJ.module_name = "sfr.exe"
...
if __name__ == "__main__":
    ...
    obj.imagename='C:\\Users\\bryantay\\Dev\\images\\sfr.jpg'
    obj.run();